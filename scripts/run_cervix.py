...
fetch_rows(table=None, *, match_all=[], match_any=[], data_source=[], add_columns=[], link_to_table='', 
            provenance=False, count_only=False, return_data_as='dataframe', output_file='', debug=False)
...
Query = {'match_any': ['primary_diagnosis_site = *%uter%*' , 'primary_diagnosis_site = *%cerv%*']} #,'data_source': 'GDC'}
cohort_name = 'Cervical'
#################################### 
